...
def solution(s):
    ...
    if len(s) == 1:
        ...
        # 자를 최대 글자 수
        splitIdx = int(len(s) / 2)
        print('splitidx=', splitIdx)


        for i in range(1, splitIdx+1):
            temp = s[:i]
            temp_result = ''
            cnt = 1
            print('i=', i)
            ...
            for j in range(i, len(s), i):
                ...
                if temp == s[j:i+j]:
                    ...
                    if cnt != 1:
                        temp_result = temp_result + str(cnt) + temp
                        print('temp_result1=', temp_result)
                    else:
                        temp_result = temp_result + temp
                        print('temp_result2=', temp_result)
            ...
            print('temp_result3=', temp_result)
